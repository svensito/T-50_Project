...
// TCPWM_P4_v2_0(Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, PinVisibility_index=false, PinVisibility_kill=false, PinVisibility_phiA=false, PinVisibility_phiB=false, PinVisibility_switch=false, PWMCompare=50, PWMCompareBuf=65535, PWMCompareSwap=0, PWMCountMode=3, PWMCountPresent=false, PWMDeadTimeCycle=0, PWMInterruptMask=0, PWMKillEvent=0, PWMLinenSignal=0, PWMLineSignal=0, PWMMode=4, PWMPeriod=100, PWMPeriodBuf=65535, PWMPeriodSwap=0, PWMPrescaler=0, PWMReloadMode=0, PWMReloadPresent=false, PWMRunMode=0, PWMSetAlign=0, PWMStartMode=0, PWMStartPresent=false, PWMStopEvent=0, PWMStopMode=0, PWMStopPresent=false, PWMSwitchMode=0, PWMSwitchPresent=false, QuadEncodingModes=0, QuadIndexMode=0, QuadIndexPresent=false, QuadInterruptMask=1, QuadPhiAMode=3, QuadPhiBMode=3, QuadStopMode=0, QuadStopPresent=false, TCCaptureMode=0, TCCapturePresent=false, TCCompare=65535, TCCompareBuf=65535, TCCompareSwap=0, TCCompCapMode=2, TCCountingModes=0, TCCountMode=3, TCCountPresent=false, TCInterruptMask=1, TCPeriod=65535, TCPrescaler=0, TCPWMCapturePresent=false, TCPWMConfig=7, TCPWMCountPresent=false, TCPWMReloadPresent=false, TCPWMStartPresent=false, TCPWMStopPresent=false, TCReloadMode=0, TCReloadPresent=false, TCRunMode=0, TCStartMode=0, TCStartPresent=false, TCStopMode=0, TCStopPresent=false, TermMode_capture=0, TermMode_cc=0, TermMode_clock=0, TermMode_count=0, TermMode_interrupt=0, TermMode_line=0, TermMode_line_n=0, TermMode_ov=0, TermMode_reload=0, TermMode_start=0, TermMode_stop=0, TermMode_un=0, TermModeStates=, TermVisibility_capture=false, TermVisibility_cc=true, TermVisibility_clock=true, TermVisibility_count=false, TermVisibility_interrupt=true, TermVisibility_line=true, TermVisibility_line_n=true, TermVisibility_ov=true, TermVisibility_reload=false, TermVisibility_start=false, TermVisibility_stop=false, TermVisibility_un=true, CY_COMPONENT_NAME=TCPWM_P4_v2_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=NavLightPWM, CY_INSTANCE_SHORT_NAME=NavLightPWM, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.1 SP1, INSTANCE_NAME=NavLightPWM, )
...
// TCPWM_P4_v2_0(Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, PinVisibility_index=false, PinVisibility_kill=false, PinVisibility_phiA=false, PinVisibility_phiB=false, PinVisibility_switch=false, PWMCompare=65535, PWMCompareBuf=65535, PWMCompareSwap=0, PWMCountMode=3, PWMCountPresent=false, PWMDeadTimeCycle=0, PWMInterruptMask=1, PWMKillEvent=0, PWMLinenSignal=0, PWMLineSignal=0, PWMMode=4, PWMPeriod=65535, PWMPeriodBuf=65535, PWMPeriodSwap=0, PWMPrescaler=0, PWMReloadMode=0, PWMReloadPresent=false, PWMRunMode=0, PWMSetAlign=0, PWMStartMode=0, PWMStartPresent=false, PWMStopEvent=0, PWMStopMode=0, PWMStopPresent=false, PWMSwitchMode=0, PWMSwitchPresent=false, QuadEncodingModes=0, QuadIndexMode=0, QuadIndexPresent=false, QuadInterruptMask=1, QuadPhiAMode=3, QuadPhiBMode=3, QuadStopMode=0, QuadStopPresent=false, TCCaptureMode=0, TCCapturePresent=true, TCCompare=65535, TCCompareBuf=65535, TCCompareSwap=0, TCCompCapMode=2, TCCountingModes=0, TCCountMode=3, TCCountPresent=false, TCInterruptMask=2, TCPeriod=3600, TCPrescaler=0, TCPWMCapturePresent=false, TCPWMConfig=1, TCPWMCountPresent=false, TCPWMReloadPresent=false, TCPWMStartPresent=false, TCPWMStopPresent=false, TCReloadMode=0, TCReloadPresent=false, TCRunMode=0, TCStartMode=0, TCStartPresent=false, TCStopMode=0, TCStopPresent=false, TermMode_capture=0, TermMode_cc=0, TermMode_clock=0, TermMode_count=0, TermMode_interrupt=0, TermMode_line=0, TermMode_line_n=0, TermMode_ov=0, TermMode_reload=0, TermMode_start=0, TermMode_stop=0, TermMode_un=0, TermModeStates=, TermVisibility_capture=true, TermVisibility_cc=true, TermVisibility_clock=true, TermVisibility_count=false, TermVisibility_interrupt=true, TermVisibility_line=false, TermVisibility_line_n=false, TermVisibility_ov=true, TermVisibility_reload=false, TermVisibility_start=false, TermVisibility_stop=false, TermVisibility_un=true, CY_COMPONENT_NAME=TCPWM_P4_v2_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PPMCounter, CY_INSTANCE_SHORT_NAME=PPMCounter, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.1 SP1, INSTANCE_NAME=PPMCounter, )
...
`else
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\3.1\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\B_UART_v2_30"
`include "C:\Program Files\Cypress\PSoC Creator\3.1\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\B_UART_v2_30\B_UART_v2_30.v"
`endif

// UART_v2_30(Address1=0, Address2=0, BaudRate=9600, BreakBitsRX=13, BreakBitsTX=13, BreakDetect=false, CRCoutputsEn=false, CtrlModeReplacementString=SyncCtl, Enable_RX=0, Enable_RXIntInterrupt=0, Enable_TX=1, Enable_TXIntInterrupt=0, EnableHWAddress=0, EnIntRXInterrupt=false, EnIntTXInterrupt=false, FlowControl=0, HalfDuplexEn=false, HwTXEnSignal=true, InternalClock=true, InternalClockUsed=1, InterruptOnAddDetect=0, InterruptOnAddressMatch=0, InterruptOnBreak=0, InterruptOnByteRcvd=0, InterruptOnOverrunError=0, InterruptOnParityError=0, InterruptOnStopError=0, InterruptOnTXComplete=false, InterruptOnTXFifoEmpty=false, InterruptOnTXFifoFull=false, InterruptOnTXFifoNotFull=false, IntOnAddressDetect=false, IntOnAddressMatch=false, IntOnBreak=false, IntOnByteRcvd=false, IntOnOverrunError=false, IntOnParityError=false, IntOnStopError=false, NumDataBits=8, NumStopBits=1, OverSamplingRate=8, ParityType=0, ParityTypeSw=false, RequiredClock=76800, RXAddressMode=0, RXBufferSize=4, RxBuffRegSizeReplacementString=uint8, RXEnable=false, TXBitClkGenDP=true, TXBufferSize=4, TxBuffRegSizeReplacementString=uint8, TXEnable=true, Use23Polling=true, CY_COMPONENT_NAME=UART_v2_30, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=TelemUART, CY_INSTANCE_SHORT_NAME=TelemUART, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=30, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.1 SP1, INSTANCE_NAME=TelemUART, )
module UART_v2_30_4 (
    rx_clk,
    rx_data,
    tx_clk,
...
// TCPWM_P4_v2_0(Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, PinVisibility_index=false, PinVisibility_kill=false, PinVisibility_phiA=false, PinVisibility_phiB=false, PinVisibility_switch=false, PWMCompare=65535, PWMCompareBuf=65535, PWMCompareSwap=0, PWMCountMode=3, PWMCountPresent=false, PWMDeadTimeCycle=0, PWMInterruptMask=1, PWMKillEvent=0, PWMLinenSignal=0, PWMLineSignal=0, PWMMode=4, PWMPeriod=65535, PWMPeriodBuf=65535, PWMPeriodSwap=0, PWMPrescaler=0, PWMReloadMode=0, PWMReloadPresent=false, PWMRunMode=0, PWMSetAlign=0, PWMStartMode=0, PWMStartPresent=false, PWMStopEvent=0, PWMStopMode=0, PWMStopPresent=false, PWMSwitchMode=0, PWMSwitchPresent=false, QuadEncodingModes=0, QuadIndexMode=0, QuadIndexPresent=false, QuadInterruptMask=1, QuadPhiAMode=3, QuadPhiBMode=3, QuadStopMode=0, QuadStopPresent=false, TCCaptureMode=0, TCCapturePresent=false, TCCompare=65535, TCCompareBuf=65535, TCCompareSwap=0, TCCompCapMode=0, TCCountingModes=0, TCCountMode=3, TCCountPresent=false, TCInterruptMask=1, TCPeriod=65535, TCPrescaler=0, TCPWMCapturePresent=false, TCPWMConfig=1, TCPWMCountPresent=false, TCPWMReloadPresent=false, TCPWMStartPresent=false, TCPWMStopPresent=false, TCReloadMode=0, TCReloadPresent=false, TCRunMode=0, TCStartMode=0, TCStartPresent=false, TCStopMode=0, TCStopPresent=false, TermMode_capture=0, TermMode_cc=0, TermMode_clock=0, TermMode_count=0, TermMode_interrupt=0, TermMode_line=0, TermMode_line_n=0, TermMode_ov=0, TermMode_reload=0, TermMode_start=0, TermMode_stop=0, TermMode_un=0, TermModeStates=, TermVisibility_capture=false, TermVisibility_cc=true, TermVisibility_clock=true, TermVisibility_count=false, TermVisibility_interrupt=true, TermVisibility_line=false, TermVisibility_line_n=false, TermVisibility_ov=true, TermVisibility_reload=false, TermVisibility_start=false, TermVisibility_stop=false, TermVisibility_un=true, CY_COMPONENT_NAME=TCPWM_P4_v2_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ServoTimer, CY_INSTANCE_SHORT_NAME=ServoTimer, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.1 SP1, INSTANCE_NAME=ServoTimer, )
...
`else
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\3.1\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_analog_virtualmux_v1_0"
`include "C:\Program Files\Cypress\PSoC Creator\3.1\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_analog_virtualmux_v1_0\cy_analog_virtualmux_v1_0.v"
`endif
...
module top ;
	...
	wire [0:0] tmpOE__NavLR_net;
	wire [0:0] tmpFB_0__NavLR_net;
	wire [0:0] tmpIO_0__NavLR_net;
	wire [0:0] tmpINTERRUPT_0__NavLR_net;
	electrical [0:0] tmpSIOVREF__NavLR_net;

	cy_psoc3_pins_v1_10
		#(.id("57888692-ca4e-4662-bca4-65fa6f816e3a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		NavLR
		 (.oe(tmpOE__NavLR_net),
		  .y({Net_150}),
		  .fb({tmpFB_0__NavLR_net[0:0]}),
		  .io({tmpIO_0__NavLR_net[0:0]}),
		  .siovref(tmpSIOVREF__NavLR_net),
		  .interrupt({tmpINTERRUPT_0__NavLR_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__NavLR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__NavB_net;
	wire [0:0] tmpFB_0__NavB_net;
	wire [0:0] tmpIO_0__NavB_net;
	wire [0:0] tmpINTERRUPT_0__NavB_net;
	electrical [0:0] tmpSIOVREF__NavB_net;
	...
	cy_psoc3_pins_v1_10
		...
		NavB
		 (.oe(tmpOE__NavB_net),
		  .y({Net_150}),
		  .fb({tmpFB_0__NavB_net[0:0]}),
		  .io({tmpIO_0__NavB_net[0:0]}),
		  .siovref(tmpSIOVREF__NavB_net),
		  .interrupt({tmpINTERRUPT_0__NavB_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__NavB_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Strobes_net;
	wire [0:0] tmpFB_0__Strobes_net;
	wire [0:0] tmpIO_0__Strobes_net;
	wire [0:0] tmpINTERRUPT_0__Strobes_net;
	electrical [0:0] tmpSIOVREF__Strobes_net;

	cy_psoc3_pins_v1_10
		#(.id("ab34df17-31ac-46e8-921c-25971bce2748"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Strobes
		 (.oe(tmpOE__Strobes_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Strobes_net[0:0]}),
		  .io({tmpIO_0__Strobes_net[0:0]}),
		  .siovref(tmpSIOVREF__Strobes_net),
		  .interrupt({tmpINTERRUPT_0__Strobes_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Strobes_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Collis_net;
	wire [0:0] tmpFB_0__Collis_net;
	wire [0:0] tmpIO_0__Collis_net;
	wire [0:0] tmpINTERRUPT_0__Collis_net;
	electrical [0:0] tmpSIOVREF__Collis_net;

	cy_psoc3_pins_v1_10
		#(.id("ab3f5ebf-6c2b-4d61-b68a-5d5189b665fd"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Collis
		 (.oe(tmpOE__Collis_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Collis_net[0:0]}),
		  .io({tmpIO_0__Collis_net[0:0]}),
		  .siovref(tmpSIOVREF__Collis_net),
		  .interrupt({tmpINTERRUPT_0__Collis_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Collis_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Ldg_net;
	wire [0:0] tmpFB_0__Ldg_net;
	wire [0:0] tmpIO_0__Ldg_net;
	wire [0:0] tmpINTERRUPT_0__Ldg_net;
	electrical [0:0] tmpSIOVREF__Ldg_net;

	cy_psoc3_pins_v1_10
		#(.id("a643b8cc-9927-40e7-8058-3b51082b4d94"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		Ldg
		 (.oe(tmpOE__Ldg_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Ldg_net[0:0]}),
		  .io({tmpIO_0__Ldg_net[0:0]}),
		  .siovref(tmpSIOVREF__Ldg_net),
		  .interrupt({tmpINTERRUPT_0__Ldg_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Ldg_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SpareLight_net;
	wire [0:0] tmpFB_0__SpareLight_net;
	wire [0:0] tmpIO_0__SpareLight_net;
	wire [0:0] tmpINTERRUPT_0__SpareLight_net;
	electrical [0:0] tmpSIOVREF__SpareLight_net;

	cy_psoc3_pins_v1_10
		#(.id("68734a49-18a9-4387-b81e-e6dddb578954"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SpareLight
		 (.oe(tmpOE__SpareLight_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SpareLight_net[0:0]}),
		  .io({tmpIO_0__SpareLight_net[0:0]}),
		  .siovref(tmpSIOVREF__SpareLight_net),
		  .interrupt({tmpINTERRUPT_0__SpareLight_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SpareLight_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__OnBoardLED_net;
	wire [0:0] tmpFB_0__OnBoardLED_net;
	wire [0:0] tmpIO_0__OnBoardLED_net;
	wire [0:0] tmpINTERRUPT_0__OnBoardLED_net;
	electrical [0:0] tmpSIOVREF__OnBoardLED_net;

	cy_psoc3_pins_v1_10
		#(.id("c6bdccaf-3c6f-44fe-9f0e-7fd6feb980d9"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		OnBoardLED
		 (.oe(tmpOE__OnBoardLED_net),
		  .y({Net_150}),
		  .fb({tmpFB_0__OnBoardLED_net[0:0]}),
		  .io({tmpIO_0__OnBoardLED_net[0:0]}),
		  .siovref(tmpSIOVREF__OnBoardLED_net),
		  .interrupt({tmpINTERRUPT_0__OnBoardLED_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__OnBoardLED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    TCPWM_P4_v2_0_3 PPMCounter (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(1'b1),
	...
	wire [0:0] tmpOE__PPMIN_net;
	wire [0:0] tmpIO_0__PPMIN_net;
	wire [0:0] tmpINTERRUPT_0__PPMIN_net;
	electrical [0:0] tmpSIOVREF__PPMIN_net;

	cy_psoc3_pins_v1_10
		#(.id("68704875-c11a-44cf-a547-cacbd0971dc0"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		PPMIN
		 (.oe(tmpOE__PPMIN_net),
		  .y({1'b0}),
		  .fb({Net_193}),
		  .io({tmpIO_0__PPMIN_net[0:0]}),
		  .siovref(tmpSIOVREF__PPMIN_net),
		  .interrupt({tmpINTERRUPT_0__PPMIN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PPMIN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    UART_v2_30_4 TelemUART (
        .cts_n(1'b0),
        .tx(Net_206),
        .rts_n(Net_256),
        .tx_en(Net_257),
        ...
        .reset(1'b0),
        .rx(1'b0),
        .tx_interrupt(Net_261),
        .rx_interrupt(Net_262),
        .tx_data(Net_263),
        .tx_clk(Net_264),
        .rx_data(Net_265),
        .rx_clk(Net_266));
    defparam TelemUART.Address1 = 0;
    defparam TelemUART.Address2 = 0;
    defparam TelemUART.EnIntRXInterrupt = 0;
    defparam TelemUART.EnIntTXInterrupt = 0;
    defparam TelemUART.FlowControl = 0;
    defparam TelemUART.HalfDuplexEn = 0;
    defparam TelemUART.HwTXEnSignal = 1;
    defparam TelemUART.NumDataBits = 8;
    defparam TelemUART.NumStopBits = 1;
    defparam TelemUART.ParityType = 0;
    defparam TelemUART.RXEnable = 0;
    defparam TelemUART.TXEnable = 1;

	wire [0:0] tmpOE__Tx_Telemetry_net;
	wire [0:0] tmpFB_0__Tx_Telemetry_net;
	wire [0:0] tmpIO_0__Tx_Telemetry_net;
	wire [0:0] tmpINTERRUPT_0__Tx_Telemetry_net;
	electrical [0:0] tmpSIOVREF__Tx_Telemetry_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("ed092b9b-d398-4703-be89-cebf998501f6"),
		  ...
		  .input_buffer_sel(2'b00))
		Tx_Telemetry
		 (.oe(tmpOE__Tx_Telemetry_net),
		  .y({Net_206}),
		  .fb({tmpFB_0__Tx_Telemetry_net[0:0]}),
		  .io({tmpIO_0__Tx_Telemetry_net[0:0]}),
		  .siovref(tmpSIOVREF__Tx_Telemetry_net),
		  .interrupt({tmpINTERRUPT_0__Tx_Telemetry_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Tx_Telemetry_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    TCPWM_P4_v2_0_5 ServoTimer (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(1'b1),
	...
	wire [0:0] tmpOE__Out_Mot_Pin_net;
	wire [0:0] tmpFB_0__Out_Mot_Pin_net;
	wire [0:0] tmpIO_0__Out_Mot_Pin_net;
	wire [0:0] tmpINTERRUPT_0__Out_Mot_Pin_net;
	electrical [0:0] tmpSIOVREF__Out_Mot_Pin_net;

	cy_psoc3_pins_v1_10
		#(.id("69733d20-e4c1-45fd-8c6b-4bbafa94fa74"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Out_Mot_Pin
		 (.oe(tmpOE__Out_Mot_Pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Out_Mot_Pin_net[0:0]}),
		  .io({tmpIO_0__Out_Mot_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Out_Mot_Pin_net),
		  .interrupt({tmpINTERRUPT_0__Out_Mot_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Out_Mot_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Out_Ail1_Pin_net;
	wire [0:0] tmpFB_0__Out_Ail1_Pin_net;
	wire [0:0] tmpIO_0__Out_Ail1_Pin_net;
	wire [0:0] tmpINTERRUPT_0__Out_Ail1_Pin_net;
	electrical [0:0] tmpSIOVREF__Out_Ail1_Pin_net;

	cy_psoc3_pins_v1_10
		#(.id("f08df048-bb9c-489f-ab87-f7600fea9286"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Out_Ail1_Pin
		 (.oe(tmpOE__Out_Ail1_Pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Out_Ail1_Pin_net[0:0]}),
		  .io({tmpIO_0__Out_Ail1_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Out_Ail1_Pin_net),
		  .interrupt({tmpINTERRUPT_0__Out_Ail1_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Out_Ail1_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Out_Ail2_Pin_net;
	wire [0:0] tmpFB_0__Out_Ail2_Pin_net;
	wire [0:0] tmpIO_0__Out_Ail2_Pin_net;
	wire [0:0] tmpINTERRUPT_0__Out_Ail2_Pin_net;
	electrical [0:0] tmpSIOVREF__Out_Ail2_Pin_net;

	cy_psoc3_pins_v1_10
		#(.id("c0b2968a-e4c0-46b7-a87b-81ec95377882"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Out_Ail2_Pin
		 (.oe(tmpOE__Out_Ail2_Pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Out_Ail2_Pin_net[0:0]}),
		  .io({tmpIO_0__Out_Ail2_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Out_Ail2_Pin_net),
		  .interrupt({tmpINTERRUPT_0__Out_Ail2_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Out_Ail2_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Out_Ele1_Pin_net;
	wire [0:0] tmpFB_0__Out_Ele1_Pin_net;
	wire [0:0] tmpIO_0__Out_Ele1_Pin_net;
	wire [0:0] tmpINTERRUPT_0__Out_Ele1_Pin_net;
	electrical [0:0] tmpSIOVREF__Out_Ele1_Pin_net;

	cy_psoc3_pins_v1_10
		#(.id("fb551710-eeb4-4c8e-8ec1-e7a0f9bb113c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Out_Ele1_Pin
		 (.oe(tmpOE__Out_Ele1_Pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Out_Ele1_Pin_net[0:0]}),
		  .io({tmpIO_0__Out_Ele1_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Out_Ele1_Pin_net),
		  .interrupt({tmpINTERRUPT_0__Out_Ele1_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Out_Ele1_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Out_Ele2_Pin_net;
	wire [0:0] tmpFB_0__Out_Ele2_Pin_net;
	wire [0:0] tmpIO_0__Out_Ele2_Pin_net;
	wire [0:0] tmpINTERRUPT_0__Out_Ele2_Pin_net;
	electrical [0:0] tmpSIOVREF__Out_Ele2_Pin_net;

	cy_psoc3_pins_v1_10
		#(.id("491a16db-e895-4e97-b8f7-1f7378d06786"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Out_Ele2_Pin
		 (.oe(tmpOE__Out_Ele2_Pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Out_Ele2_Pin_net[0:0]}),
		  .io({tmpIO_0__Out_Ele2_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Out_Ele2_Pin_net),
		  .interrupt({tmpINTERRUPT_0__Out_Ele2_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Out_Ele2_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Out_Rud_Pin_net;
	wire [0:0] tmpFB_0__Out_Rud_Pin_net;
	wire [0:0] tmpIO_0__Out_Rud_Pin_net;
	wire [0:0] tmpINTERRUPT_0__Out_Rud_Pin_net;
	electrical [0:0] tmpSIOVREF__Out_Rud_Pin_net;

	cy_psoc3_pins_v1_10
		#(.id("1484267c-d4d4-4d00-9d28-ba2a497abf70"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Out_Rud_Pin
		 (.oe(tmpOE__Out_Rud_Pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Out_Rud_Pin_net[0:0]}),
		  .io({tmpIO_0__Out_Rud_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Out_Rud_Pin_net),
		  .interrupt({tmpINTERRUPT_0__Out_Rud_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Out_Rud_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Out_Fl1_Pin_net;
	wire [0:0] tmpFB_0__Out_Fl1_Pin_net;
	wire [0:0] tmpIO_0__Out_Fl1_Pin_net;
	wire [0:0] tmpINTERRUPT_0__Out_Fl1_Pin_net;
	electrical [0:0] tmpSIOVREF__Out_Fl1_Pin_net;

	cy_psoc3_pins_v1_10
		#(.id("8ba6f971-a6d5-4122-9c4b-2e371dd080a4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Out_Fl1_Pin
		 (.oe(tmpOE__Out_Fl1_Pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Out_Fl1_Pin_net[0:0]}),
		  .io({tmpIO_0__Out_Fl1_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Out_Fl1_Pin_net),
		  .interrupt({tmpINTERRUPT_0__Out_Fl1_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Out_Fl1_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Out_Fl2_Pin_net;
	wire [0:0] tmpFB_0__Out_Fl2_Pin_net;
	wire [0:0] tmpIO_0__Out_Fl2_Pin_net;
	wire [0:0] tmpINTERRUPT_0__Out_Fl2_Pin_net;
	electrical [0:0] tmpSIOVREF__Out_Fl2_Pin_net;

	cy_psoc3_pins_v1_10
		#(.id("b5cdb8aa-9d48-4c59-b2ad-476e6eb5f524"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Out_Fl2_Pin
		 (.oe(tmpOE__Out_Fl2_Pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Out_Fl2_Pin_net[0:0]}),
		  .io({tmpIO_0__Out_Fl2_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Out_Fl2_Pin_net),
		  .interrupt({tmpINTERRUPT_0__Out_Fl2_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Out_Fl2_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Out_Ge1_Pin_net;
	wire [0:0] tmpFB_0__Out_Ge1_Pin_net;
	wire [0:0] tmpIO_0__Out_Ge1_Pin_net;
	wire [0:0] tmpINTERRUPT_0__Out_Ge1_Pin_net;
	electrical [0:0] tmpSIOVREF__Out_Ge1_Pin_net;

	cy_psoc3_pins_v1_10
		#(.id("12b143d9-dc0e-4539-87e4-b007084ab0ab"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Out_Ge1_Pin
		 (.oe(tmpOE__Out_Ge1_Pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Out_Ge1_Pin_net[0:0]}),
		  .io({tmpIO_0__Out_Ge1_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Out_Ge1_Pin_net),
		  .interrupt({tmpINTERRUPT_0__Out_Ge1_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Out_Ge1_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Out_Ge2_Pin_net;
	wire [0:0] tmpFB_0__Out_Ge2_Pin_net;
	wire [0:0] tmpIO_0__Out_Ge2_Pin_net;
	wire [0:0] tmpINTERRUPT_0__Out_Ge2_Pin_net;
	electrical [0:0] tmpSIOVREF__Out_Ge2_Pin_net;

	cy_psoc3_pins_v1_10
		#(.id("c26df30a-ecae-4246-8573-fb19b05c467b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Out_Ge2_Pin
		 (.oe(tmpOE__Out_Ge2_Pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Out_Ge2_Pin_net[0:0]}),
		  .io({tmpIO_0__Out_Ge2_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Out_Ge2_Pin_net),
		  .interrupt({tmpINTERRUPT_0__Out_Ge2_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Out_Ge2_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Out_Ge3_Pin_net;
	wire [0:0] tmpFB_0__Out_Ge3_Pin_net;
	wire [0:0] tmpIO_0__Out_Ge3_Pin_net;
	wire [0:0] tmpINTERRUPT_0__Out_Ge3_Pin_net;
	electrical [0:0] tmpSIOVREF__Out_Ge3_Pin_net;

	cy_psoc3_pins_v1_10
		#(.id("dbb00d6a-fbe0-4b21-b96b-0f8d057f02c1"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Out_Ge3_Pin
		 (.oe(tmpOE__Out_Ge3_Pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Out_Ge3_Pin_net[0:0]}),
		  .io({tmpIO_0__Out_Ge3_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Out_Ge3_Pin_net),
		  .interrupt({tmpINTERRUPT_0__Out_Ge3_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Out_Ge3_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Out_Sp1_Pin_net;
	wire [0:0] tmpFB_0__Out_Sp1_Pin_net;
	wire [0:0] tmpIO_0__Out_Sp1_Pin_net;
	wire [0:0] tmpINTERRUPT_0__Out_Sp1_Pin_net;
	electrical [0:0] tmpSIOVREF__Out_Sp1_Pin_net;

	cy_psoc3_pins_v1_10
		#(.id("358e1cfc-fea7-414c-abe2-179346229811"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Out_Sp1_Pin
		 (.oe(tmpOE__Out_Sp1_Pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Out_Sp1_Pin_net[0:0]}),
		  .io({tmpIO_0__Out_Sp1_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Out_Sp1_Pin_net),
		  .interrupt({tmpINTERRUPT_0__Out_Sp1_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Out_Sp1_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Out_Sp2_Pin_net;
	wire [0:0] tmpFB_0__Out_Sp2_Pin_net;
	wire [0:0] tmpIO_0__Out_Sp2_Pin_net;
	wire [0:0] tmpINTERRUPT_0__Out_Sp2_Pin_net;
	electrical [0:0] tmpSIOVREF__Out_Sp2_Pin_net;

	cy_psoc3_pins_v1_10
		#(.id("843a945b-11f0-4435-a01e-414f1fca8cdf"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Out_Sp2_Pin
		 (.oe(tmpOE__Out_Sp2_Pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Out_Sp2_Pin_net[0:0]}),
		  .io({tmpIO_0__Out_Sp2_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Out_Sp2_Pin_net),
		  .interrupt({tmpINTERRUPT_0__Out_Sp2_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Out_Sp2_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    SCB_P4_v2_0_6 I2CM (
        .interrupt(Net_317),
        .clock(1'b0));

    ADC_SAR_SEQ_P4_v2_0_7 ADC (
        .Vref(Net_514),
        .sdone(Net_515),
        .eoc(Net_516),
        .aclk(1'b0),
	...
	wire [0:0] tmpOE__In_Speed_net;
	wire [0:0] tmpFB_0__In_Speed_net;
	wire [0:0] tmpIO_0__In_Speed_net;
	wire [0:0] tmpINTERRUPT_0__In_Speed_net;
	electrical [0:0] tmpSIOVREF__In_Speed_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		In_Speed
		 (.oe(tmpOE__In_Speed_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__In_Speed_net[0:0]}),
		  .analog({Net_364}),
		  .io({tmpIO_0__In_Speed_net[0:0]}),
		  .siovref(tmpSIOVREF__In_Speed_net),
		  .interrupt({tmpINTERRUPT_0__In_Speed_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__In_Speed_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
