...
uint32 I2CM_I2CMasterSendStart(uint32 slaveAddress, uint32 bitRnW)
{
    ...
    if(I2CM_CHECK_I2C_FSM_IDLE)
    {
        ...
        {
            //I2CM_DisableInt();    // bla bla This is required to comment out, otherwise no I2C functionality
...
uint32 I2CM_I2CMasterSendStop(void)
{
    ...
    if(I2CM_CHECK_I2C_MASTER_ACTIVE)
    {
        ...
        */
        ...
        else /* I2CM_INTR_MASTER_I2C_BUS_ERROR is set */
        {
            errStatus = I2CM_I2C_MSTR_ERR_BUS_ERR;
            resetIp   = I2CM_I2C_RESET_ERROR;
        }
...
uint32 I2CM_I2CMasterWriteByte(uint32 theByte)
{
    ...
    if(I2CM_CHECK_I2C_MASTER_ACTIVE)
    {
        ...
        else /* I2CM_INTR_MASTER_I2C_BUS_ERROR set is */
        {
            I2CM_state = I2CM_I2C_FSM_IDLE;
                         errStatus = I2CM_I2C_MSTR_ERR_BUS_ERR;
                         resetIp   = I2CM_I2C_RESET_ERROR;
...
/*******************************************************************************
* Function Name: I2CM_I2CReStartGeneration
********************************************************************************
*
* Summary:
...
void I2CM_I2CReStartGeneration(void)
{
    ...
    uint32 status = I2CM_I2C_STATUS_REG;

    while(I2CM_WAIT_SDA_SET_HIGH)
    {
    ...
    if(0u != (status & I2CM_I2C_STATUS_M_READ))
    {
    ...
    cmd  = I2CM_I2C_MASTER_CMD_M_START;
    cmd |= I2CM_CHECK_I2C_STATUS(I2CM_I2C_STATUS_M_READ) ?
                (I2CM_I2C_MASTER_CMD_M_NACK) : (0u);

    I2CM_I2C_MASTER_CMD_REG = cmd;
