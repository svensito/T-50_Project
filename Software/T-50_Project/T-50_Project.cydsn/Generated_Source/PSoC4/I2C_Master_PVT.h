...
#define I2C_Master_SetSpiExtClkInterruptMode(interruptMask) I2C_Master_WRITE_INTR_SPI_EC_MASK(interruptMask)
#define I2C_Master_ClearSpiExtClkInterruptSource(interruptMask) I2C_Master_CLEAR_INTR_SPI_EC(interruptMask)
...
#define I2C_Master_GetExtSpiClkInterruptSourceMasked()           (I2C_Master_INTR_SPI_EC_MASKED_REG)
    ...
    extern void I2C_Master_SetPins(uint32 mode, uint32 subMode, uint32 uartTxRx);
