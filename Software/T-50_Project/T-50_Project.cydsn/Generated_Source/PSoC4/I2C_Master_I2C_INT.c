...
CY_ISR(I2C_Master_I2C_ISR)
{
                ...
                if(I2C_Master_CHECK_I2C_FSM_DATA) /* Data phase */
                {
                    if(I2C_Master_CHECK_I2C_FSM_RD) /* Reading */
                    {
                        ...
                        */
                        if(I2C_Master_CHECK_INTR_RX_MASKED(I2C_Master_INTR_RX_FULL))
                        {
                            ...
                            if(diffCount > I2C_Master_FIFO_SIZE)
                            {
                                diffCount = I2C_Master_FIFO_SIZE;
                            }
                            else
                            {
                                if(0u == diffCount)
                    ...
                    else /* Writing */
                    {
                        ...
                        */
                        ...
                        {
                            while(I2C_Master_FIFO_SIZE != I2C_Master_GET_TX_FIFO_ENTRIES)
                            {
            ...
            */
            if(I2C_Master_CHECK_INTR_RX_MASKED(I2C_Master_INTR_RX_FULL))
            {
                ...
                diffCount =  I2C_Master_slWrBufSize -
                            (I2C_Master_slWrBufIndex + I2C_Master_FIFO_SIZE);

                if(diffCount > I2C_Master_FIFO_SIZE) /* Proceed transaction */
                {
                    diffCount   = I2C_Master_FIFO_SIZE;
                    endTransfer = 0u;  /* Continue active transfer */
                }
    ...
    */
    ...
    {
        I2C_Master_CTRL_REG &= (uint32) ~I2C_Master_CTRL_ENABLED; /* Disable SCB block */
        ...
        I2C_Master_CTRL_REG |= (uint32) I2C_Master_CTRL_ENABLED;  /* Enable SCB block */
    }
}
