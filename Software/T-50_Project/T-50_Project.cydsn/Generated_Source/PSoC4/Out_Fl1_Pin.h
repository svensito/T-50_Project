...
#define Out_Fl1_Pin_DM_ALG_HIZ         (0x00u << Out_Fl1_Pin_DRIVE_MODE_SHIFT)
#define Out_Fl1_Pin_DM_DIG_HIZ         (0x01u << Out_Fl1_Pin_DRIVE_MODE_SHIFT)
#define Out_Fl1_Pin_DM_RES_UP          (0x02u << Out_Fl1_Pin_DRIVE_MODE_SHIFT)
#define Out_Fl1_Pin_DM_RES_DWN         (0x03u << Out_Fl1_Pin_DRIVE_MODE_SHIFT)
#define Out_Fl1_Pin_DM_OD_LO           (0x04u << Out_Fl1_Pin_DRIVE_MODE_SHIFT)
#define Out_Fl1_Pin_DM_OD_HI           (0x05u << Out_Fl1_Pin_DRIVE_MODE_SHIFT)
#define Out_Fl1_Pin_DM_STRONG          (0x06u << Out_Fl1_Pin_DRIVE_MODE_SHIFT)
#define Out_Fl1_Pin_DM_RES_UPDWN       (0x07u << Out_Fl1_Pin_DRIVE_MODE_SHIFT)
