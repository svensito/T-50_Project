...
*
*  I2CM_sda_DM_STRONG     Strong Drive 
*  I2CM_sda_DM_OD_HI      Open Drain, Drives High 
*  I2CM_sda_DM_OD_LO      Open Drain, Drives Low 
*  I2CM_sda_DM_RES_UP     Resistive Pull Up 
*  I2CM_sda_DM_RES_DWN    Resistive Pull Down 
*  I2CM_sda_DM_RES_UPDWN  Resistive Pull Up/Down 
*  I2CM_sda_DM_DIG_HIZ    High Impedance Digital 
*  I2CM_sda_DM_ALG_HIZ    High Impedance Analog 
*
* Return: 
*  None
*
