    ...
    *******************************************************************************/
    void I2C_Master_I2CInit(const I2C_Master_I2C_INIT_STRUCT *config)
    {
        ...
        else
        {
            ...
            I2C_Master_CTRL_REG     = I2C_Master_GET_CTRL_ADDR_ACCEPT(config->acceptAddr) |
                                            I2C_Master_GET_CTRL_EC_AM_MODE (config->enableWake);
            ...
            I2C_Master_RX_CTRL_REG      = I2C_Master_GET_RX_CTRL_MEDIAN(config->enableMedianFilter) |
...
void I2C_Master_I2CStop(void)
{
    ...
    *******************************************************************************/
    ...
    {
        /* I2C_Master_INTR_I2C_EC_WAKE_UP is masked-off in the interrupt */
    }
